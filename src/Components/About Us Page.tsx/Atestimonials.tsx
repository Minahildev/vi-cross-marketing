...
function ATestimonials() {
  return (
    <section className="bg-black text-black w-full px-5 sm:px-10 lg:px-20 py-10">
      {/* Section Heading */}
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 pt-10">
        {/* Testimonial Card 1 */}
        <div className="bg-slate-200 border rounded-lg p-6 flex flex-col justify-between">
          ...
          <div className="flex items-center gap-4">
            <img src={Msgid2} alt="Sarah Jack" className="w-12 h-12 rounded-full" />
            <div>
        ...
        <div className="bg-slate-200 border rounded-lg p-6 flex flex-col justify-between">
          ...
          <div className="flex items-center gap-4">
            <img src={Msgid1} alt="John Smith" className="w-12 h-12 rounded-full" />
            <div>
        ...
        <div className="bg-slate-200 border rounded-lg p-6 flex flex-col justify-between">
          ...
          <div className="flex items-center gap-4">
            <img src={Msgid3} alt="Ramos Leo" className="w-12 h-12 rounded-full" />
            <div>
